...
import os
import sys
from kdllib import load_checkpoint, theano_one_hot, concatenate, concatenate
...
if __name__ == "__main__":
    ...
    def sample_step(x_tm1, h1_tm1, h2_tm1, h3_tm1, k_tm1, w_tm1, ctx):
        ...
        shuff_inpt_t = x_tm1.dimshuffle(1, 0, 'x')
        theano.printing.Print("shuff_inpt_t.shape")(shuff_inpt_t.shape)
        j_t = concatenate((shuff_inpt_t, vinp_t), axis=-1)
        def sample_out_step(j_t, v_h1_tm1):
    ...
    # Combine "time" and "minibatch"
    shuff_inpt = inpt.reshape((shuff_inpt_shapes[2], -1, 1))
