...
from kdllib import sample_softmax, relu
...
if __name__ == "__main__":
    ...
    att_size = 10
    n_components = 3
    n_features = X_mb.shape[-1]
    n_chars = vocabulary_size
    n_softmax = 10
    n_out = n_features * n_softmax
    ...
    init_x = as_shared(np_zeros((minibatch_size, n_features)))
    ...
    (sampled, h1_s, h2_s, h3_s, k_s, w_s, stop_s, stop_h) = sample_step(
